    ...
    licoes: [
      ...
      ,
      {
        ...
        desafios: [
          ...
          { p: "Insira três clientes de uma vez, com ids <b>25, 26 e 27</b>, nomes <b>Zeca Prado</b>, <b>Alice Ferraz</b> e <b>Breno Sales</b>, e-mails <b>zeca.prado@email.com</b>, <b>alice.ferraz@email.com</b> e <b>breno.sales@email.com</b>, todos de <b>Serra</b>, status <b>ativo</b>, cadastro <b>2026-09-21</b> e sem telefone (NULL).", r: "INSERT INTO clientes (id_cliente, nome, email, cidade, status_cliente, data_cadastro, telefone) VALUES (25, 'Zeca Prado', 'zeca.prado@email.com', 'Serra', 'ativo', '2026-09-21', NULL), (26, 'Alice Ferraz', 'alice.ferraz@email.com', 'Serra', 'ativo', '2026-09-21', NULL), (27, 'Breno Sales', 'breno.sales@email.com', 'Serra', 'ativo', '2026-09-21', NULL);", v: ["SELECT id_cliente, nome, cidade, status_cliente, data_cadastro, telefone FROM clientes ORDER BY id_cliente;"], dica: "NULL vai sem aspas — é ausência de valor, não a palavra “NULL”." },
    ...
    licoes: [
      ...
      ,
      {
        ...
        desafios: [
          ...
          { p: "Crie a view <b>vw_faturamento_categoria</b> com uma linha por categoria. Junte itens e produtos, <b>agrupe por categoria com GROUP BY</b>, e traga a <b>categoria</b> e a <b>soma de quantidade × preço unitário</b> (coluna <b>receita</b>).", r: "CREATE VIEW vw_faturamento_categoria AS SELECT pr.categoria, SUM(i.quantidade * i.preco_unit) AS receita FROM itens_pedido i JOIN produtos pr ON pr.id_produto = i.id_produto GROUP BY pr.categoria;", v: ["SELECT * FROM vw_faturamento_categoria ORDER BY categoria;"], dica: "Dá para guardar até um JOIN com agrupamento." },
      ...
      ,
      {
        ...
        desafios: [
          ...
          { p: "Com <b>INSERT OR IGNORE</b>, tente inserir dois produtos de uma vez: o id <b>2</b> (que já existe e deve ser ignorado, sem erro — pode pôr quaisquer dados nele) e o id <b>22</b> (<b>Régua 30cm</b>, Papelaria, 6.00, estoque 70), que deve entrar.", r: "INSERT OR IGNORE INTO produtos (id_produto, nome, categoria, preco, estoque) VALUES (2, 'Nome Qualquer', 'Papelaria', 1.00, 1), (22, 'Régua 30cm', 'Papelaria', 6.00, 70);", v: ["SELECT * FROM produtos ORDER BY id_produto;"], dica: "INSERT OR IGNORE engole o conflito da linha repetida e insere as demais." },
          { p: "Use ON CONFLICT para <b>somar 100 ao estoque</b> do produto <b>3</b> caso ele já exista. Tente inserir id <b>3</b> (<b>Post-it Colorido</b>, Papelaria, 11.50, estoque 5).", r: "INSERT INTO produtos (id_produto, nome, categoria, preco, estoque) VALUES (3, 'Post-it Colorido', 'Papelaria', 11.50, 5) ON CONFLICT(id_produto) DO UPDATE SET estoque = produtos.estoque + 100;", v: ["SELECT id_produto, estoque FROM produtos ORDER BY id_produto;"], dica: "Dentro do DO UPDATE, produtos.estoque é o valor que já estava lá." },
