...
window.CURRICULO = {
  ...
  dias: [
    ...
    { d:19, ato:"III", titulo:"Boss: caso de detetive", ref:"#ref-sql",
      vemos:"Um caso de detetive no SQLNoir (em português), cronometrado e em célula. Só se resolve com SELECT, WHERE e JOIN." },
  ...
  missoes: [
    ...
    { ini:19, fim:19, titulo:"Boss: caso de detetive (SQLNoir)",
      texto:"Resolvam um caso no SQLNoir, em português — comecem por \u201cA Maleta Desaparecida\u201d. Interroguem os suspeitos com consultas até achar o culpado. Entreguem a query final e o nome do culpado." },
